...
void onInit(CBlob@ this)
{
	...
	//General
	settings.CLIP = 1; //Amount of ammunition in the gun at creation
	...
	//Sound
	settings.FIRE_VOLUME = 1.5f; //Sound volume
	...
	//Offset
	settings.MUZZLE_OFFSET = Vec2f(-8, -2); //Where the muzzle flash appears
	...
	this.set_Vec2f("laser_offset", Vec2f(3, -1));
}
