...
void onInit(CBlob@ this)
{
	...
	settings.AMMO_BLOB = "buckshot"; //Ammunition the gun takes
	...
	settings.B_DAMAGE = 0.65f; //1 is 1 heart
	...
	//Offset
	settings.MUZZLE_OFFSET = Vec2f(-15.5, -2); //Where the muzzle flash appears
