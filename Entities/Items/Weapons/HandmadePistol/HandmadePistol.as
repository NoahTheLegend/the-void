...
void onInit(CBlob@ this)
{
	...
	settings.FIRE_INTERVAL = 7; //Time in between shots
	settings.RELOAD_TIME = 10; //Time it takes to reload (in ticks)
	settings.AMMO_BLOB = "kineticrifleammosmall"; //Ammunition the gun takes
	...
	settings.B_TYPE = Hitters::arrow; //Type of bullet the gun shoots | hitter
	...
	//Offset
	settings.MUZZLE_OFFSET = Vec2f(-12.5, -1.7); //Where the muzzle flash appears
