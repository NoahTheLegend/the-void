...
FUI::AnimationText settings_anim_text_messages_volume();
...
void onRender(CRules@ this) {
  ...
  if (settings_is_open) {
    ...
    if (settings_anim_rect_title.isEnd()) {
      ...
      if (settings_anim_rect_canvas.isEnd()) {
        ...
        settings_anim_text_messages_volume.play();
        settings_anim_rect_messages_volume.play();
      }
    }
  } else {
    settings_anim_rect_messages_volume.playReverse();
    settings_anim_text_messages_volume.playReverse();
  ...
  if (settings_anim_text_messages_mute.isPlayOrEnd())
    messages_mute = canvas_settings.drawToggle(messages_mute, Vec2f(8, settings_anim_rect_title.br.y + 6));
  if (settings_anim_text_messages_mute.isPlayOrEnd())
    canvas_settings.drawText(settings_anim_text_messages_mute.text, Vec2f(8 + 16 + 4, settings_anim_rect_title.br.y + 4));
  if (settings_anim_text_messages_volume.isPlayOrEnd())
    canvas_settings.drawText(settings_anim_text_messages_volume.text, Vec2f(8, settings_anim_rect_title.br.y + TEXT_H + 4));
...
void SettingsAnimationReset() {
  ...
  settings_anim_text_messages_volume.text = "";
  settings_anim_text_messages_volume.result = "Messages volume";
  settings_anim_text_messages_volume.duration = 15;
  settings_anim_text_messages_volume.frame = 0;
  settings_anim_rect_messages_volume.tl_start = Vec2f(8, LABEL_H + TEXT_H + TEXT_H + 8);
  settings_anim_rect_messages_volume.br_start = Vec2f(48, LABEL_H + TEXT_H + TEXT_H + LABEL_H + 8);
  settings_anim_rect_messages_volume.tl_end = Vec2f(8, LABEL_H + TEXT_H + TEXT_H + 8);
  settings_anim_rect_messages_volume.br_end = Vec2f(canvas_settings.getSize().x / 2, LABEL_H + TEXT_H + TEXT_H + LABEL_H + 8);
